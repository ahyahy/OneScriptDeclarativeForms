...
namespace osdf
{
    [ContextClass("ДфМозаикаКартинки", "DfBackgroundRepeat")]
    public class DfBackgroundRepeat : AutoContext<DfBackgroundRepeat>, ICollectionContext, IEnumerable<IValue>
    {
