...
namespace osdf
{
    [ContextClass("ДфОписаниеМедиа", "DfCaptionMedia")]
    public class DfCaptionMedia : AutoContext<DfCaptionMedia>
    {

        public DfCaptionMedia()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('figcaption'));" + @"
