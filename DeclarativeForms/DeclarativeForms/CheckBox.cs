...
namespace osdf
{
    [ContextClass("ДфФлажок", "DfCheckBox")]
    public class DfCheckBox : AutoContext<DfCheckBox>
    {
...
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
            ...
            strFunc = "mapKeyEl.get('" + ItemKey + "').type = 'checkbox';";
            DeclarativeForms.SendStrFunc(strFunc);		
        ...
        [ContextProperty("Неопределено", "Indeterminate")]
        public bool Indeterminate
        {
            ...
            {
                indeterminate = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['indeterminate'] = " + indeterminate.ToString().ToLower() + ";";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }
