...
namespace oscs
{
    ...
    public class ClientServerDeclarForms : AutoContext<ClientServerDeclarForms>
    {
        ...
        public static CsTcpServer cstcpserver;
...
namespace oscs
{
    ...
    public class CsTcpServer : AutoContext<CsTcpServer>
    {
        public CsTcpServer(int p1)
        {
            ...
            oscs.ClientServerDeclarForms.cstcpserver = this;
        ...
        [ContextProperty("ОтправитьСообщениеФорме", "SendMessageToForm")]
        public IValue SendMessageToForm { get; set; }
        ...
        public void Start()
        {
            ...
            //не помню когда поставил, но это нужное
            osdf.DeclarativeForms.clientServerUploaded = true;
        }
