...
namespace osdf
{
    [ContextClass("ДфВыборЦвета", "DfColorSelection")]
    public class DfColorSelection : AutoContext<DfColorSelection>
    {

        public DfColorSelection()
        {
            ...
            strFunc = "setInputType(\u0022" + Name + "\u0022, \u0022" + "color" + "\u0022)";
            DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";		
