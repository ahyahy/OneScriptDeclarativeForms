...
namespace osdf
{
    [ContextClass("ДфСтильРазделителяКолонок", "DfColumnRuleStyle")]
    public class DfColumnRuleStyle : AutoContext<DfColumnRuleStyle>, ICollectionContext, IEnumerable<IValue>
    {
