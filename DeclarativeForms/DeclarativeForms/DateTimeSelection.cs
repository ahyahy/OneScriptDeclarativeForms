...
namespace osdf
{
    [ContextClass("ДфВыборДатыВремени", "DfDateTimeSelection")]
    public class DfDateTimeSelection : AutoContext<DfDateTimeSelection>
    {

        public DfDateTimeSelection()
        {
            ...
            strFunc = "setInputType(\u0022" + Name + "\u0022, \u0022" + "datetime" + "\u0022)";
            DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";		
