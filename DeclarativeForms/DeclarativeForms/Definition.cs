...
namespace osdf
{
    [ContextClass("ДфОпределение", "DfDefinition")]
    public class DfDefinition : AutoContext<DfDefinition>
    {

        public DfDefinition()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('dd'));" + @"
