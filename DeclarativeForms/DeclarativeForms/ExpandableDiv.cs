...
namespace osdf
{
    [ContextClass("ДфРаскрываемыйБлок", "DfExpandableDiv")]
    public class DfExpandableDiv : AutoContext<DfExpandableDiv>
    {

        public DfExpandableDiv()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('details'));" + @"
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
        ...
        public bool Open
        {
            ...
            {
                open = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['open'] = " + open.ToString().ToLower() + ";";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + DeclarativeForms.funDelimiter;
            }
        }
