...
namespace osdf
{
    [ContextClass("ДфЗаголовокРаскрываемогоБлока", "DfExpandableDivHeader")]
    public class DfExpandableDivHeader : AutoContext<DfExpandableDivHeader>
    {

        public DfExpandableDivHeader()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('summary'));" + @"
