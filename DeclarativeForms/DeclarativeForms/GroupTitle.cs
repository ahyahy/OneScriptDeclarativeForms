...
namespace osdf
{
    [ContextClass("ДфЗаголовокГруппы", "DfGroupTitle")]
    public class DfGroupTitle : AutoContext<DfGroupTitle>
    {

        public DfGroupTitle()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('legend'));" + @"
