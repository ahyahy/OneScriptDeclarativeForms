...
namespace osdf
{
    [ContextClass("ДфЯчейкаЗаголовка", "DfHeaderCell")]
    public class DfHeaderCell : AutoContext<DfHeaderCell>
    {

        public DfHeaderCell()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('th'));" + @"
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
        ...
        [ContextProperty("ДиапазонКолонок", "ColSpan")]
        public int ColSpan
        {
            get { return colSpan; }
            set
            {
                colSpan = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['colSpan'] = '" + colSpan + "';";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }

        public int rowSpan { get; set; }
        [ContextProperty("ДиапазонСтрок", "RowSpan")]
        public int RowSpan
        {
            get { return rowSpan; }
            set
            {
                rowSpan = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['rowSpan'] = '" + rowSpan + "';";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }
