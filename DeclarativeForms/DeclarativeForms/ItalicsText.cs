...
namespace osdf
{
    [ContextClass("ДфКурсивТекст", "DfItalicsText")]
    public class DfItalicsText : AutoContext<DfItalicsText>
    {

        public DfItalicsText()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('cite'));" + @"
