...
namespace osdf
{
    [ContextClass("ДфПодпись", "DfLabel")]
    public class DfLabel : AutoContext<DfLabel>
    {

        public DfLabel()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('label'));" + @"
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
        ...
        public string HtmlFor
        {
            ...
            {
                htmlFor = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['htmlFor'] = '" + htmlFor + "';";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + DeclarativeForms.funDelimiter;
            }
        }
