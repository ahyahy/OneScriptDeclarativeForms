...
namespace osdf
{
    [ContextClass("ДфСсылка", "DfLink")]
    public class DfLink : AutoContext<DfLink>
    {

        public DfLink()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('a'));" + @"
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
        ...
        public string Href
        {
            ...
            {
                href = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['href'] = '" + href + "';";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }
        ...
        public string Target
        {
            ...
            {
                target = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['target'] = '" + target + "';";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }
        ...
        [ContextProperty("Подсказка", "Title")]
        public string Title
        {
            get { return title; }
            set
        ...
        [ContextProperty("Скачать", "Download")]
        public string Download
        {
            ...
            {
                download = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['download'] = '" + download + "';";
                DeclarativeForms.SendStrFunc(strFunc);
            }
        }
