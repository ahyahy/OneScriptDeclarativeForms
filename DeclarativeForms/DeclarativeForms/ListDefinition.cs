...
namespace osdf
{
    [ContextClass("ДфСписокОпределений", "DfListDefinition")]
    public class DfListDefinition : AutoContext<DfListDefinition>
    {

        public DfListDefinition()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('dl'));" + @"
