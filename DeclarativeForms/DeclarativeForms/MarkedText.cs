...
namespace osdf
{
    [ContextClass("ДфМаркированныйТекст", "DfMarkedText")]
    public class DfMarkedText : AutoContext<DfMarkedText>
    {

        public DfMarkedText()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('mark'));" + @"
