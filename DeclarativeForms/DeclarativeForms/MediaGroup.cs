...
namespace osdf
{
    [ContextClass("ДфМедиаГруппа", "DfMediaGroup")]
    public class DfMediaGroup : AutoContext<DfMediaGroup>
    {

        public DfMediaGroup()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('figure'));" + @"
