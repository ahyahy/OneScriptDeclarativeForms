...
namespace osdf
{
    [ContextClass("ДфСтильКонтура", "DfOutlineStyle")]
    public class DfOutlineStyle : AutoContext<DfOutlineStyle>, ICollectionContext, IEnumerable<IValue>
    {
