...
namespace osdf
{
    [ContextClass("ДфРазрывСтраницыПосле", "DfPageBreakAfter")]
    public class DfPageBreakAfter : AutoContext<DfPageBreakAfter>, ICollectionContext, IEnumerable<IValue>
    {
