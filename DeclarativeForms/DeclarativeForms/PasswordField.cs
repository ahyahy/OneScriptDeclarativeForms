...
namespace osdf
{
    [ContextClass("ДфПолеПароля", "DfPasswordField")]
    public class DfPasswordField : AutoContext<DfPasswordField>
    {

        public DfPasswordField()
        {
            ...
            strFunc = "setInputType(\u0022" + Name + "\u0022, \u0022" + "password" + "\u0022)";
            DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";		
