...
namespace osdf
{
    [ContextClass("ДфФорматированныйТекст", "DfPreformattedText")]
    public class DfPreformattedText : AutoContext<DfPreformattedText>
    {

        public DfPreformattedText()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('pre'));" + @"
