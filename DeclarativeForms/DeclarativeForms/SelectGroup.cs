...
namespace osdf
{
    [ContextClass("ДфГруппировкаПоляСписка", "DfSelectGroup")]
    public class DfSelectGroup : AutoContext<DfSelectGroup>
    {

        public DfSelectGroup()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "createElement(\u0022" + "optgroup" + "\u0022, \u0022" + ItemKey + "\u0022)";
        ...
        public string Label
        {
            ...
            set
            {
                label = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "label" + "\u0022, \u0022" + label + "\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
