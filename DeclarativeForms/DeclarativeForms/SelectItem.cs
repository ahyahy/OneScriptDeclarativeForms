...
namespace osdf
{
    [ContextClass("ДфЭлементПоляСписка", "DfSelectItem")]
    public class DfSelectItem : AutoContext<DfSelectItem>
    {

        public DfSelectItem()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('option'));" + @"
mapElKey.set(mapKeyEl.get('" + ItemKey + "'), '" + ItemKey + "');";
        ...
        public bool Selected
        {
            ...
            {
                selected = value;
                string strFunc = "mapKeyEl.get('" + ItemKey + "')['selected'] = " + selected.ToString().ToLower() + ";";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + DeclarativeForms.funDelimiter;
            }
        }
