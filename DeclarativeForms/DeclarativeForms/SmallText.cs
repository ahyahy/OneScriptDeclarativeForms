...
namespace osdf
{
    [ContextClass("ДфМелкийТекст", "DfSmallText")]
    public class DfSmallText : AutoContext<DfSmallText>
    {

        public DfSmallText()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('small'));" + @"
