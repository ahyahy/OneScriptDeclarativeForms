...
namespace osdf
{
    [ContextClass("ДфОбластьТаблицы", "DfTableBody")]
    public class DfTableBody : AutoContext<DfTableBody>
    {

        public DfTableBody()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('tbody'));" + @"
