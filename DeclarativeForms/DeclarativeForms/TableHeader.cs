...
namespace osdf
{
    [ContextClass("ДфШапкаТаблицы", "DfTableHeader")]
    public class DfTableHeader : AutoContext<DfTableHeader>
    {

        public DfTableHeader()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('thead'));" + @"
