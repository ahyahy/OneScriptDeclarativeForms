...
namespace osdf
{
    [ContextClass("ДфОбластьТекста", "DfTextArea")]
    public class DfTextArea : AutoContext<DfTextArea>
    {

        public DfTextArea()
        {
            Name = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "createElement(\u0022" + "textarea" + "\u0022, \u0022" + Name + "\u0022)";
        ...
        public string TextWrap
        {
            ...
            set
            {
                wrap = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + Name + "\u0022, \u0022" + "wrap" + "\u0022, \u0022" + wrap + "\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
