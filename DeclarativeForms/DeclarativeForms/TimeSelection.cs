...
namespace osdf
{
    [ContextClass("ДфВыборВремени", "DfTimeSelection")]
    public class DfTimeSelection : AutoContext<DfTimeSelection>
    {

        public DfTimeSelection()
        {
            ...
            strFunc = "setInputType(\u0022" + Name + "\u0022, \u0022" + "time" + "\u0022)";
            DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";		
