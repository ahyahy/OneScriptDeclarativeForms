...
namespace osdf
{
    [ContextClass("ДфПодчеркнутыйТекст", "DfUnderlineText")]
    public class DfUnderlineText : AutoContext<DfUnderlineText>
    {

        public DfUnderlineText()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('u'));" + @"
