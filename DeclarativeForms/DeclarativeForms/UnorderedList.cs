...
namespace osdf
{
    [ContextClass("ДфНеупорядоченныйСписок", "DfUnorderedList")]
    public class DfUnorderedList : AutoContext<DfUnorderedList>
    {

        public DfUnorderedList()
        {
            ItemKey = "d" + Path.GetRandomFileName().Replace(".", "");
            string strFunc = "mapKeyEl.set('" + ItemKey + "', document.createElement('ul'));" + @"
