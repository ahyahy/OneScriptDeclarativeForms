...
namespace osdf
{
    ...
    public class DfVideo : AutoContext<DfVideo>
    {
        ...
        public DfVideo()
        {
            ...
            string strFunc = "createElement(\u0022" + "video" + "\u0022, \u0022" + ItemKey + "\u0022)";
        ...
        public bool Muted
        {
            ...
            set
            {
                ...
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "muted" + "\u0022, \u0022" + muted.ToString().ToLower() + "\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
        ...
        public int Height
        {
            ...
            set
            {
                height = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "height" + "\u0022, \u0022" + height + "px\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
        ...
        public bool Controls
        {
            ...
            set
            {
                controls = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "controls" + "\u0022, \u0022" + controls.ToString().ToLower() + "\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
        ...
        public string VideoType
        {
            ...
            set
            {
                videoType = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "type" + "\u0022, \u0022" + videoType + "\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
        ...
        public int Width
        {
            ...
            set
            {
                width = value;
                //setProperty(nameElement, nameProperty, valueProperty)
                string strFunc = "setProperty(\u0022" + ItemKey + "\u0022, \u0022" + "width" + "\u0022, \u0022" + width + "px\u0022)";
                DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";
            }
        }
