...
namespace osdf
{
    [ContextClass("ДфВыборНедели", "DfWeekSelection")]
    public class DfWeekSelection : AutoContext<DfWeekSelection>
    {

        public DfWeekSelection()
        {
            ...
            strFunc = "setInputType(\u0022" + Name + "\u0022, \u0022" + "week" + "\u0022)";
            DeclarativeForms.strFunctions = DeclarativeForms.strFunctions + strFunc + ";";		
